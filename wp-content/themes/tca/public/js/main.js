...
/* harmony import */ var _components_megamenu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/megamenu.js */ "./src/js/components/megamenu.js");
/* harmony import */ var _components_megamenu_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_megamenu_js__WEBPACK_IMPORTED_MODULE_2__);
  ...
  function toggleEventView(viewtarget) {
    ...
    if (viewtarget == "grid") {
      ...
      $('.event-container').fadeOut(function () {
        $(".event-container").removeClass("list-view").addClass("grid-view").fadeIn();
      });
    } else {
      $(".grid-toggle").removeClass("active");
      $(".list-toggle").addClass("active");
      $(".event-container").fadeOut(function () {
        $(".event-container").removeClass("grid-view").addClass("list-view").fadeIn();
      });
    }
  }
