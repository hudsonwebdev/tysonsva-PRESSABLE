...
$wrapper_classes = array( 'tca-football-fixtures-block' );
...
<div <?php echo $wrapper; ?>>
	...
	if ( is_wp_error( $api ) ) :
		...
		if ( empty( $rows ) ) :
			...
			?>
			<div class="<?php echo esc_attr( $list_classes ); ?>" role="list"<?php echo $list_style ? ' style="' . esc_attr( $list_style ) . '"' : ''; ?>>
				<?php
				foreach ( $rows as $match ) :
					...
					?>
					<article class="tca-football-fixtures__row" role="listitem">
						<div class="tca-football-fixtures__row-time">
							<?php if ( $parts['date'] ) : ?>
								<span class="tca-football-fixtures__date"><?php echo esc_html( date('F j', strtotime($parts['date'])) ); ?></span>
							<?php endif; ?>
							<?php if ( $parts['time'] ) : ?>
