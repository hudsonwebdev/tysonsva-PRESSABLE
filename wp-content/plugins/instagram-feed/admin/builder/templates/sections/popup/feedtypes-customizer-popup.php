<div class="sbi-fb-feedtypescustomizer-pp-ctn sb-fs-boss sbi-fb-center-boss"
	 role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'Switch feed type', 'instagram-feed' ); ?>"
	...
	<div class="sbi-fb-feedtypes-popup sbi-fb-popup-inside">
		...
		<div class="sbi-fb-feedtypescustomizer-content sbi-fb-fs">
			...
			?>
			<button type="button" v-if="! maxTypesAdded()" class="sbi-addsource-type-btn sbi-fb-fs"
				 @click.prevent.default="toggleFeedTypesChooserPopup()"
				 :aria-label="genericText.addSourceType">
				<svg width="14" height="14" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
