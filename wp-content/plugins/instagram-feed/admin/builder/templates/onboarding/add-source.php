<div class="sb-onboarding-wizard-step-wrapper sb-onboarding-wizard-step-addsource sb-fs">
    ...
    <div class="sb-onboarding-wizard-sources-list sb-fs">
        ...
        <button type="button" class="sb-onboarding-wizard-source-newitem sb-fs"
        ...
        <div class="sb-onboarding-wizard-source-item sb-fs" v-for="source in sourcesList">
            ...
            <button type="button" class="sb-onboarding-wizard-source-item-delete"
                    @click.prevent.default="openDialogBox('deleteSource', source)"
                    :aria-label="genericText.delete + ' ' + source.username">
                <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
