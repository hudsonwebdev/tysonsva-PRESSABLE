	...
	public function statuses_and_info()
	{
		$return = array(
			...
			'modal' => array(
				...
				'timesIcon' => '<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M14.2084 2.14275L12.8572 0.791504L7.50008 6.14859L2.143 0.791504L0.791748 2.14275L6.14883 7.49984L0.791748 12.8569L2.143 14.2082L7.50008 8.85109L12.8572 14.2082L14.2084 12.8569L8.85133 7.49984L14.2084 2.14275Z" fill="#141B38"/></svg>',
			...
			if ($valid_new_access_token) {
				...
				$success_args = array(
					...
					'icon' => array(
						...
						'wrap' => '<span class="sb-notice-icon"><img {src} {alt}></span>',
						'alt' => '',
					),
					'styles' => array(
						'display' => 'flex',
