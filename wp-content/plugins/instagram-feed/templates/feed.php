...
<div id="sb_instagram" role="region" aria-label="<?php esc_attr_e('Instagram feed', 'instagram-feed'); ?>" <?php echo $feed_classes . $feed_styles; ?>
	...
	<div id="sbi_images" role="list" <?php echo $sb_images_style; ?>>
		<?php
