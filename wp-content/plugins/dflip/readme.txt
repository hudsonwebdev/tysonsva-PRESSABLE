...
* Fix: Play sound only whne page flips
...
* Improve: Hash navigation improved. Hash is onl update when share button is clicked.
...
= 2.3.48: =
* Add: Pseudo Zoom - you can zoom muliple times extra without increasing the max texture size.
...
= 2.3: =
* Add: (Beta)Direct support for PDF files in media. Flipbooks posts are not compulsory now
