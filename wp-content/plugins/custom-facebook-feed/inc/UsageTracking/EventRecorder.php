<?php
/**
 * Records usage events for the current period (stored in cff_smash_usage_events).
 *
...
class EventRecorder {
	...
	const OPTION_NAME = 'cff_smash_usage_events';
	...
	public static function record_active_day() {
		$option_key = \CustomFacebookFeed\UsageTracking\Config::OPTION_ACTIVE_DATES;
	...
	public static function record_session_duration( $seconds ) {
		...
		$option_key = \CustomFacebookFeed\UsageTracking\Config::OPTION_SESSION_DURATIONS;
