<script type="text/x-template" id="sb-confirm-dialog-component">
	<div class="sb-dialog-ctn sb-fs-boss cff-fb-center-boss" v-if="dialogBoxElement.active">
		<div class="sb-dialog-popup cff-fb-popup-inside" role="dialog" aria-modal="true" aria-labelledby="sb-confirm-dialog-heading">
			<button type="button" class="cff-fb-popup-cls" aria-label="Close dialog" @click.prevent.default="closeConfirmDialog" @keydown.enter.prevent="closeConfirmDialog" @keydown.space.prevent="closeConfirmDialog"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
			...
			<div class="sb-dialog-remove-source cff-fb-fs" v-if="dialogBoxElement.type == 'deleteSourceCustomizer'">
				<div class="cff-fb-srcs-item" :data-type="sourceToDelete.account_type">
					<div class="cff-fb-srcs-item-avatar">
						<img alt="" aria-hidden="true" :src="typeof sourceToDelete.avatar_url !== 'undefined' && sourceToDelete.account_type === 'group' ? sourceToDelete.avatar_url : 'https://graph.facebook.com/'+sourceToDelete.account_id+'/picture'">
					</div>
			...
			<div class="sb-dialog-popup-content cff-fb-fs">
				<strong id="sb-confirm-dialog-heading" v-html="dialogBoxElement.heading"></strong>
