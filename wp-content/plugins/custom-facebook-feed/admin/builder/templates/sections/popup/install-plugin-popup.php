<script type="text/x-template" id="install-plugin-popup">
    <div class="cff-fb-source-ctn sb-fs-boss cff-fb-center-boss" v-if="viewsActive.installPluginPopup">
        <div class="cff-fb-source-popup cff-fb-popup-inside cff-install-plugin-modal" role="dialog" aria-modal="true" aria-labelledby="cff-fb-install-plugin-popup-heading">
            <button type="button" class="cff-fb-popup-cls" aria-label="Close dialog" @click.prevent.default="$parent.activateView('installPluginPopup')" @keydown.enter.prevent="$parent.activateView('installPluginPopup')" @keydown.space.prevent="$parent.activateView('installPluginPopup')">
            ...
            <div class="cff-install-plugin-body cff-fb-fs">
                <div class="cff-install-plugin-header">
                    ...
                    <div class="sb-plugin-name">
                        <h3 id="cff-fb-install-plugin-popup-heading">
                            {{plugins.name}}
