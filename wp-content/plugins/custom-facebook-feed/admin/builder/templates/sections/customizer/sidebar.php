...
<div class="sb-customizer-sidebar" v-bind:class="{ 'sb-onboarding-highlight' : viewsActive.onboardingStep === 2 || viewsActive.onboardingStep === 3 }">
	<div class="sb-customizer-sidebar-sec1 cff-fb-fs">
		...
		<div class="sb-customizer-sidebar-sec-ctn cff-fb-fs"
			...
			<div v-for="(section, sectionId) in customizerSidebarBuilder[customizerScreens.activeTab].sections">
				<button type="button" class="sb-customizer-sidebar-sec-el cff-fb-fs" v-if="!section.isHeader" @click.prevent.default="switchCustomizerSection(sectionId, section)">
		...
		<div class="cff-fb-fs" v-if="customizerScreens.activeSection != null">
			<div class="sb-customizer-sidebar-header cff-fb-fs" :data-separator="customizerScreens.activeSectionData.separator ? customizerScreens.activeSectionData.separator : ''">
				<div class="sb-customizer-sidebar-breadcrumb cff-fb-fs">
					...
					<button type="button" v-if="customizerScreens.parentActiveSection != null" @click.prevent.default="switchCustomizerSection(customizerScreens.parentActiveSection, customizerScreens.parentActiveSectionData)" class="sb-customizer-sidebar-breadcrumb-link cff-child-breadcrumb">
						<svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
							<path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
						</svg>{{customizerScreens.parentActiveSectionData.heading}}
					</button>
					<button type="button" v-if="customizerScreens.parentActiveSection == 'customize_posts' && nestedStylingSection.includes(customizerScreens.activeSection)" @click.prevent.default="backToPostElements()" class="sb-customizer-sidebar-breadcrumb-link cff-child-breadcrumb">
						<svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
							<path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
						</svg>Elements
					</button>
