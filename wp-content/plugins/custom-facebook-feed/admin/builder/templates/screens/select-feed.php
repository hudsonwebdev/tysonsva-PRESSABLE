<div v-if="viewsActive.pageScreen == 'selectFeed'" class="cff-fb-fs">
	...
	<div class="cff-fb-create-ctn cff-fb-wrapper">
		<div class="cff-fb-heading">
			...
			<button type="button" class="cff-fb-btn cff-fb-slctf-nxt cff-fb-btn-ac cff-btn-orange" :data-active="creationProcessCheckAction()" @click.prevent.default="creationProcessNext()">
	...
	<div class="cff-fb-ft-action cff-fb-slctfd-action cff-fb-fs">
		<div class="cff-fb-wrapper">
			<button type="button" class="cff-fb-slctf-back cff-fb-hd-btn cff-btn-grey" @click.prevent.default="creationProcessBack()"><svg aria-hidden="true" width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
