<div class="sb-onboarding-wizard-step-wrapper sb-onboarding-wizard-step-addsource sb-fs">
	<div class="sb-onboarding-wizard-step-top sb-fs">
		...
		<h1 tabindex="-1" class="sb-onboarding-wizard-step-heading" v-html="onboardingWizardStepContent['add-source'].heading"></h1>
	</div>
	<div class="sb-onboarding-wizard-sources-list sb-fs">

		<div class="sb-onboarding-wizard-source-newitem sb-fs" role="button" tabindex="0" :aria-label="genericText.addNew" @click.prevent.default="activateView('sourcePopup', 'creationRedirect')" @keydown.enter.prevent.default="activateView('sourcePopup', 'creationRedirect')" @keydown.space.prevent.default="activateView('sourcePopup', 'creationRedirect')">
		...
		<div class="sb-onboarding-wizard-source-item sb-fs" v-for="source in sourcesList">
			...
			<div class="sb-onboarding-wizard-source-item-delete" role="button" tabindex="0" :aria-label="'Delete ' + source.username" @click.stop.prevent.default="openDialogBox('deleteSource', source)" @keydown.enter.prevent.default="openDialogBox('deleteSource', source)" @keydown.space.prevent.default="openDialogBox('deleteSource', source)">
