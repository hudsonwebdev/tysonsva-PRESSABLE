	...
	public static function getTranslation() {
        ...
        <ul class="fbv-in_feature">
          ...
          <li>30-day Refund Guarantee</li>
			...
			'activated_license'                 => __( 'FileBird Pro is activated and ready to use.', 'filebird' ),
			'buy_another_license'               => __( 'Buy another license', 'filebird' ),
			'license_key'                       => __( 'License Key:', 'filebird' ),
			'copy_license_key'                  => __( 'Copy license key', 'filebird' ),
			'copy_license_key_failed'           => __( 'Could not copy the license key.', 'filebird' ),
			'copied'                            => __( 'Copied!', 'filebird' ),
			'license_note'                      => __( 'If you are using a development site and plan to activate this license on the production domain later, deactivate it here first.', 'filebird' ),
